...
{
/* N19A code for HQ-360184 by p-wumingzhu1 at 20240103 start*/
/* N19A code for HQ-353547 by p-songweijie at 20240107 start*/
	if (page0_data[0] == NVT_SN1 && page0_data[1] == NVT_SN2)		//NVT(NV)--first_supplier
		*bat_id = BATTERY_VENDOR_FIRST;
	else if (page0_data[0] == SWD_SN)  //swd--second_supplier
		*bat_id = BATTERY_VENDOR_SECOND;
	else if (page0_data[0] == GY_SN1 || page0_data[0] == GY_SN2)		//冠宇(G)--third_supplier
		*bat_id = BATTERY_VENDOR_THIRD;
	else
		*bat_id = BATTERY_VENDOR_UNKNOW;
/* N19A code for HQ-353547 by p-songweijie at 20240107 end*/
/* N19A code for HQ-360184 by p-wumingzhu1 at 20240103 end*/
